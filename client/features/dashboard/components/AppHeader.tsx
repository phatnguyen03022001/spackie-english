  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center px-4 lg:px-8 bg-transparent transition-all">
      <nav className="flex items-center gap-2 text-sm font-medium" aria-label="Breadcrumb">
        ...
        {/* HOME LINK: Trỏ về dashboard của role tương ứng */}
        <Link
          href={`/${rolePath}/dashboard` as string}
        ...
        {pathSegments.map((segment, index) => {
          ...
          // QUAN TRỌNG: Build lại href chuẩn bao gồm role để tránh lỗi 500
          // Kết quả mong muốn: /teacher/vocabulary, /teacher/vocabulary/manage
